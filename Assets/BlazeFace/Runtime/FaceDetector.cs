...
namespace MediaPipe.BlazeFace
{
    ...
    public sealed partial class FaceDetector : System.IDisposable
    {
        ...
        void DeallocateObjects()
        {
            ...
            Debug.Log($"Buffer Count: Post1={_output.post1.count}, Post2={_output.post2.count}, Count={_output.count.count}");
            if (_output.post2.count <= 0)
            {
                Debug.LogError("Post2 buffer has invalid count. Skipping detection.");
                return;
